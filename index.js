const sessionName = "DIO-GPT";
const donet = "https://t.me/X_Dio_official_X";
const owner = ["2001227137847"]; // Put your number here ex: ["91xxxxxxxxx"]
const {
...
async function startHisoka() {
  ...
  client.ev.on("connection.update", async (update) => {
    ...
    if (connection === "close") {
      ...
      console.log(color("JOIN: MY TELEGRAM: https://t.me/X_Dio_official_X", "yellow"));
